...
export default function LocalLifeScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Local Life: Talk to a Local About Their Life</Text>
      <Text style={styles.description}>
        Engage with a local and learn about their daily life. Capture the moment for future memories!
      </Text>
